...
public class QTESystem : MonoBehaviour
{
    ...
    public KeyCode[] possibleKeys = { KeyCode.A, KeyCode.S, KeyCode.D, KeyCode.W }; // Возможные клавиши
    public TextMeshProUGUI qteText; // Текст для отображения QTE
    public TextMeshProUGUI progressText; // Текст для отображения прогресса
    public float messageDisplayTime = 2f; // Время отображения сообщений "Успех" и "Провал"
    ...
    // Генерация случайной последовательности из 5 клавиш
